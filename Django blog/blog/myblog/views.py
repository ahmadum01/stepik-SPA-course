...
class MainView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'myblog/home.html', context={'page_obj': page_obj, 'posts': posts})
...
class SignUpView(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'myblog/signup.html', context={'form': SigUpForm()})
...
class SignInView(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'myblog/signin.html', context={'form': SignInForm()})
...
class FeedBackView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                send_mail(f'От {name} | {subject}', message, from_email, ['ahmadbooksite@gmail.com'])
